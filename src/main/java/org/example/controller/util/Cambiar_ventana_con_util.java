...
public class Cambiar_ventana_con_util {
    /*
    ¿Como usarlo?
    ...
    */
    ...
    public static void cambiar_scene(Event event, String view) throws IOException {
        ...
        Parent nueva_escena = FXMLLoader.load(Cambiar_ventana_con_util.class.getResource("/view/"+ view +".fxml"));
    ...
    public static void cambiar_scene(Event event, String view, Shortcut_DTO dto) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(Cambiar_ventana_con_util.class.getResource("/view/" + view + ".fxml"));
